...
const numberAllAnimalsAfrica = animals.filter((animal) =>
  animal.continents.includes("Africa")
).length;
const averageWeightOfAllAnimalsInAfrica =
  weightOfAllAnimalsInAfrica / numberAllAnimalsAfrica;
